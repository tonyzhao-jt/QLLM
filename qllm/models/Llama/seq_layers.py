...
class LlamaModelSeq(LlamaModel):
    """
...
class LlamaForCausalLMSeq(LlamaForCausalLM):
...
if __name__ == '__main__':
    ...
    model_name = 'llama'
    model_size = '7b'
    llama_7b, tokenizer = llama.load_pretained_model_from_net(key)
    # sample text
    input_ids = tokenizer.encode("Hi, where is my dog", return_tensors="pt")
    model = LlamaForCausalLMSeq.from_pretrained(key)
    # 32 layers
    decoder_layer_nums = get_decoder_layer_nums(model_name, model_size)
